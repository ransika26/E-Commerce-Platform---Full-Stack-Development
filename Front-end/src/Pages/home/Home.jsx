              ...
              <div>
                <img
                  src={`http://localhost:3000/uploads/${
                    product.SellerID?.LogoImageFile || "placeholder-logo.png"
                  }`}
                  alt={product.brand || "Seller Logo"}
                />
              </div>
              <div className="name">
                <h4>{product.SellerID?.SellerName || "Unknown Seller"}</h4>
              </div>
            </div>
            <div className="card-image">
              <img
                src={`http://localhost:3000/uploads/${
                  product.ImageFile || "placeholder-image.png"
                }`}
